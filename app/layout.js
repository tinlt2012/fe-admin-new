...
export const metadata = {
    title: 'Tinlt - Next.Js Admin Dashboard Template',
    description: 'Tinlt - Next JS admin dashboard template is free and available on GitHub. Create your stunning web apps with our Free Next js template. An open-source admin dashboard built using the new router, server components, and everything new in Next.js 13.',
    keywords: 'Tinlt, Next.js 13, Admin dashboard, admin template, web apps, bootstrap 5, admin theme'
}
